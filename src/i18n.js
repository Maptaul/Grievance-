...
const resources = {
  en: {
    translation: {
      ...
      office_locations_title: "Office Locations",
      office_locations_select_placeholder: "Select an Office Location",
      ...
      locations: {
        ...
        south_pahartali: "South Pahartali",
        jalalabad: "Jalalabad",
        panchlaish: "Panchlaish",
        chandgaon: "Chandgaon",
        mohra: "Mohra",
        east_sholashahar: "East Sholashahar",
        west_sholashahar: "West Sholashahar",
        sholokbahar: "Sholokbahar",
        north_pahartali: "North Pahartali",
        north_kattali: "North Kattali",
        south_kattali: "South Kattali",
        saraipara: "Saraipara",
        pahartali: "Pahartali",
        lalkhan_bazar: "Lalkhan Bazar",
        bagmaniram: "Bagmaniram",
        chawkbazar: "Chawkbazar",
        west_bakalia: "West Bakalia",
        east_bakalia: "East Bakalia",
        south_bakalia: "South Bakalia",
        dewan_bazar: "Dewan Bazar",
        jamal_khan: "Jamal Khan",
        enayet_bazar: "Enayet Bazar",
        north_pathantooly: "North Pathantooly",
        north_agrabad: "North Agrabad",
        rampur: "Rampur",
        north_halishahar: "North Halishahar",
        south_agrabad: "South Agrabad",
        pathantooly: "Pathantooly",
        west_madarbari: "West Madarbari",
        east_madarbari: "East Madarbari",
        alkaran: "Alkaran",
        andarkilla: "Andarkilla",
        firingee_bazar: "Firingee Bazar",
        patharghata: "Patharghata",
        boxirhat: "Boxirhat",
        gosaildanga: "Gosaildanga",
        north_middle_halishahar: "North Middle Halishahar",
        south_middle_halishahar: "South Middle Halishahar",
        south_halishahar: "South Halishahar",
        north_patenga: "North Patenga",
        south_patenga: "South Patenga",
      },
      ...
      "category.mosquitoes": "mosquitoes",
      "category.road lamp lights": "road lamp lights",
      "category.Public Spaces": "Public Spaces",
      "category.Public Toilets": "Public Toilets",
      "category.Waterlogging": "Waterlogging",
      "category.Parking": "Parking",
      "category.poster": "poster",

      oss_header: "One Stop Service (OSS)",
      oss_image_alt: "One Stop Service Illustration",
      oss_title: "One Stop Service",
      oss_description: `A Revolutionary Digital Citizen Service Platform
Shapla OSS is a visionary, citizen-focused digital service platform developed by JIONEX IT Services Co. LLC in collaboration with the Chattogram City Corporation. This smart, unified platform is designed to integrate all key municipal and public services into a single digital system—enabling faster, paperless, and more transparent service delivery.
The initiative aims to transform how citizens interact with local government by centralizing access to vital services, reducing delays, and eliminating bureaucratic inefficiencies. Shapla OSS promotes sustainable governance by minimizing paper usage and supporting environmentally responsible practices. It is a significant step toward realizing the national vision of Digital Bangladesh and building future-ready Smart Cities.

Above all, Shapla OSS is committed to enhancing the citizen experience by delivering efficient, secure, and trustworthy public services—thereby fostering greater transparency, accountability, and public trust in governance.`,
      ...
      notice_11:
        "Visit Shapla One Stop Service (Shapla OSS) by Chattogram City Corporation",
      ...
      joined: "Joined",
      office_locations_search_placeholder: "Search Office Locations",
      office_locations_no_locations_found: "No office locations found",
      office_locations_loading: "Loading office locations...",
      ...
      batali_hill_tigerpass: "Batali Hill, Tigerpass, Chattogram",
      phone_label: "Phone",
      email_label: "Email",
      fax_label: "Fax",
      info_ccc_email: "smart@ccc.gov.bd",
  ...
  bn: {
    translation: {
      ...
      "category.mosquitoes": "মশা",
      "category.road lamp lights": "রাস্তার বাতি",
      "category.Public Spaces": "জনসাধারণের স্থান",
      "category.Public Toilets": "জনসাধারণের টয়লেট",
      "category.Waterlogging": "জলাবদ্ধতা",
      "category.Parking": "পার্কিং",
      "category.poster": "পোস্টার",
      ...
      notice_11:
        "চট্টগ্রাম সিটি কর্পোরেশন কর্তৃক শাপলা ওয়ান স্টপ সার্ভিস (শাপলা ওএসএস) পরিদর্শন করুন।",
      ...
      office_locations_loading: "অফিসের অবস্থান লোড হচ্ছে...",
      office_locations_no_locations_found: "কোনো অফিসের অবস্থান পাওয়া যায়নি",
      ...
      OSS: "শাপলা ওএসএস",
      office_locations_search_placeholder: "অফিসের অবস্থান অনুসন্ধান করুন",

      oss_header: "শাপলা ওয়ান স্টপ সার্ভিস (শাপলা ওএসএস)",
      oss_image_alt: "শাপলা ওয়ান স্টপ সার্ভিস প্ল্যাটফর্ম",
      oss_title: "শাপলা ওয়ান স্টপ সার্ভিস (শাপলা ওএসএস)",
      ...
      office_locations_select_placeholder: "অফিসের অবস্থান নির্বাচন করুন",
      ...
      locations: {
        ...
        south_pahartali: "দক্ষিণ পাহাড়তলী",
        jalalabad: "জালালাবাদ",
        panchlaish: "পাঁচলাইশ",
        chandgaon: "চাঁদগাঁও",
        mohra: "মোহরা",
        east_sholashahar: "পূর্ব শোলশহর",
        west_sholashahar: "পশ্চিম শোলশহর",
        sholokbahar: "শোলকবাহার",
        north_pahartali: "উত্তর পাহাড়তলী",
        north_kattali: "উত্তর কাট্টালী",
        south_kattali: "দক্ষিণ কাট্টালী",
        saraipara: "সরাইপাড়া",
        pahartali: "পাহাড়তলী",
        lalkhan_bazar: "লালখান বাজার",
        bagmaniram: "বাগমনিরাম",
        chawkbazar: "চকবাজার",
        west_bakalia: "পশ্চিম বাকলিয়া",
        east_bakalia: "পূর্ব বাকলিয়া",
        south_bakalia: "দক্ষিণ বাকলিয়া",
        dewan_bazar: "দেওয়ান বাজার",
        jamal_khan: "জামাল খান",
        enayet_bazar: "এনায়েত বাজার",
        north_pathantooly: "উত্তর পাঠানটুলি",
        north_agrabad: "উত্তর আগ্রাবাদ",
        rampur: "রামপুর",
        north_halishahar: "উত্তর হালিশহর",
        south_agrabad: "দক্ষিণ আগ্রাবাদ",
        pathantooly: "পাঠানটুলি",
        west_madarbari: "পশ্চিম মাদারবাড়ি",
        east_madarbari: "পূর্ব মাদারবাড়ি",
        alkaran: "আলকরন",
        andarkilla: "আন্দরকিল্লা",
        firingee_bazar: "ফিরিঙ্গি বাজার",
        patharghata: "পাথরঘাটা",
        boxirhat: "বক্সিরহাট",
        gosaildanga: "গোশাইলডাঙ্গা",
        north_middle_halishahar: "উত্তর মধ্য হালিশহর",
        south_middle_halishahar: "দক্ষিণ মধ্য হালিশহর",
        south_halishahar: "দক্ষিণ হালিশহর",
        north_patenga: "উত্তর পতেঙ্গা",
        south_patenga: "দক্ষিণ পতেঙ্গা",
      },

      office_locations_title: "অফিসের অবস্থান",
