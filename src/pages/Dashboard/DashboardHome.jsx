...
const DashboardHome = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6 md:p-8">
      <div className="bg-gray-200 p-8 rounded-xl shadow-lg max-w-2xl w-full text-center">
        ...
        <div className="mt-6">
          <img
            ...
            alt="Profile"
            className="w-20 h-20 rounded-full border-4 border-blue-500 mx-auto shadow-md object-cover"
          />
        </div>
      </div>
    </div>
